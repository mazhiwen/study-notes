define(function(require) {
	...
	AJAXMY.send('/article/list',{category_code:'watched',page:1,size:30},function(data){
		var dr=data['result'],
			articleHtml='';
		...
		$(".bourgeoisie_left").append(articleHtml);
	});
	...
	AJAXMY.send('/article/list',{category_code:'report',page:1,size:3},function(data){
		...
		$(".bourgeoisie_right").append(rightArticle+'</div>');
	});
